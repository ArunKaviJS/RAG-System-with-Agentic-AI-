...
docsearch = FAISS.load_local("Index", embedding_model, allow_dangerous_deserialization=True)
...
def verify_answer(answer):
    if "Question:" in answer and "Helpful Answer:" in answer:
        parts = answer.split("Helpful Answer:")
        return parts[1].strip()
    elif "Helpful Answer:" in answer:
        return answer.split("Helpful Answer:")[1].strip()
    return answer.strip()
